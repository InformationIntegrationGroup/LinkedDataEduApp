...
define(['lib/jquery',
  ...
  function ($, CompositeSlideGenerator, LoadingSlideGenerator, CustomSlideGenerator, ErrorSlideGenerator, Summarizer, urls) {
    "use strict";
    ...
    **/
    ...
    $.extend(TopicToTopicSlideGenerator.prototype,
      CompositeSlideGenerator.prototype,
      {
                ...
                success: function (path) {
                  ...
                  $(summ).one('generated', function (event, story) {
                    story.steps.forEach(function (step) {
                      ...
                      self.addGenerator(new CustomSlideGenerator(step.topic, step.text));
                    });
    	...
    	hasNext: function(){
    		if(this.curSlideIndex < this.generators.length) return true;
    		else return false;
    	},
    	
    	next: function(){
    		var generator = this.generators[this.curSlideIndex];
    		this.curSlideIndex++;

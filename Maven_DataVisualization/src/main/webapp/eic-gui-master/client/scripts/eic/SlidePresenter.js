 ...
 */
define(['eic-gui-master/client/scripts/lib/jquery', 'eic-gui-master/client/scripts/eic/Logger', 'eic-gui-master/client/scripts/eic/WAVPlayer'], function ($, Logger, WAVPlayer) {
  "use strict";

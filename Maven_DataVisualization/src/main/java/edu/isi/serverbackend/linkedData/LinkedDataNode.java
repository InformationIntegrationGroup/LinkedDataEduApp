		...
		while(result.hasNext()){
			...
			if(language != null){
				if(objectLiteral.getLanguage().equals("en")){
					//String name = retrieveNameFromURI(bindingSet.getValue("object").stringValue().trim());
		...
		while(result.hasNext()){
			...
			if(language != null){
				if(subjectLiteral.getLanguage().equals("en")){
					//String name = retrieveNameFromURI(bindingSet.getValue("subject").stringValue().trim());
